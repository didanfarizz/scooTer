      ...
      <div className="lg:px-14 lg:flex lg:flex-col lg:gap-y-4 lg:py-32">
        ...
        <div className="lg:flex flex items-center justify-center lg:justify-start py-2 animate__animated animate__fadeInUp animate__delay-4s">
          {isSignedIn ? (
            ...
            <Button onClick={() => navigate('/payment')} className="lg:w-96 lg:text-2xl bg-[#3d3d3d] text-[#e5e5e5] rounded-[15px] hover:bg-[#e5e5e5] hover:text-[#3d3d3d]" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              Pesan Sekarang!
            </Button>
          ) : (
            // Button non-aktif jika user belum login
            <Button disabled className="lg:w-96 lg:text-2xl bg-[#3d3d3d] text-[#e5e5e5] rounded-[15px] cursor-not-allowed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              Pesan Sekarang!
            </Button>
          )}
        </div>
